...
required_columns = ["عدد الغرف", "المساحة", "السعر الاجمالي", "السعر المربع"]
...
st.dataframe(df_filtered[["عدد الغرف", "المساحة", "السعر الاجمالي", "السعر المربع"]].sort_values(by="السعر الاجمالي"))
