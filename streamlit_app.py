...
📊 **تحليل البيانات:**
<br>
🔹 إذا كنت تبحث عن شقة، فإن **حي النرجس والملقا** فيهما أكبر عدد من الشقق، مما يعني أن لديك فرصًا أكبر للعثور على الشقة المناسبة لك.
<br>
🔹 أما إذا كنت مهتمًا بالفلل، فإن **حي المونسية والرمال** يتميزان بأكبر عدد من الفلل، مما يجعلهما خيارات مثالية إذا كنت تبحث عن مساحة مستقلة.
</div>
""", unsafe_allow_html=True)
